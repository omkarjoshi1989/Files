...
| 18 | Recent files screen MUST have all these Sort options name, size, date, type and sort by PATH          | ✅ Done | Dropdown sort menu in top bar; supports Name, Size, Date, Type, Path; tap same option toggles asc/desc                                                                                                             |
