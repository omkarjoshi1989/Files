...
| 24 | Pagination for file list (100 items) . As soon as user reaches 100th list item, load more below       | in progress |                                                                                                                                                                                                                    |
...
|---|------------------------------------------------------------------|---------|---------------------------------------------------------------------------------------------|
Adjust all UI visible for audio play in landscape node. Suggestion is to show album art of leftmost half of the screen and rest all file name, play oause prev next and repeat control , align all to right half side of screen
inside all files activity DONT SHOW '/storage/emulated/0' in files path e.g. 