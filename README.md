...
| 3  | Music play screen: add toggle controls like repeat current song, repeat entire folder audio files, and seek bar         | Pending |                                                                             |
...
| 2  | Video playback: Gesture controls for brightness and volume                                                              | Pending |                                                                             |
| 3  | Video Playback: Double tap to seek forward/backward                                                                     | Pending |                                                                             |
| 4  | Video: Aspect ratio toggle (Fit, Fill, Stretch, 16:9, 4:3)                                                              | Pending |                                                                             |
| 5  | Video: Subtitle support (SRT, VTT) and audio track selection                                                            | Pending |                                                                             |
| 6  | Video: Playback speed control (0.5x to 2.0x)                                                                            | Pending |                                                                             |
| 7  | Video: Picture-in-Picture (PiP) mode                                                                                    | Pending |                                                                             |
| 8  | Video: Screen lock to prevent accidental touches                                                                        | Pending |                                                                             |
| 9  | Video: videos Background play toggle                                                                                    | Pending |                                                                             |
| 11 | Video: Long press to play video in 1.5x speed; release to restore speed                                                 | Pending |                                                                             |
| 12 | Video: Double tap left/right half of screen to rewind/forward 10 seconds                                                | Pending |                                                                             |
| 13 | Video: Save ONLY video files' playback position. everytime i am opening video it MUST resume from last played duration. | pending |                                                                             |
